...
module.exports = function(app) {
  ...
  app.post("/newbudget", function(req, res) {
    ...
    db.Spending.create({
      ...
      var cableInternetPercentage =
        dbSpending.cable_internet / dbSpending.monthlyIncome;
      ...
      var entertainmentPercentage =
        dbSpending.entertainment / dbSpending.monthlyIncome;
      var totalExpensesPercent = (
        housingPercentage +
        utilitiesPercentage +
        phonePercentage +
        cableInternetPercentage +
        foodPercentage +
        clothingPercentage +
        beautyPercentage +
      ...
      var totalExpenses =
        parseInt(dbSpending.housing) +
        parseInt(dbSpending.utilities) +
        parseInt(dbSpending.phone) +
        parseInt(dbSpending.food) +
        parseInt(dbSpending.clothing) +
        parseInt(dbSpending.beauty) +
        parseInt(dbSpending.entertainment);
